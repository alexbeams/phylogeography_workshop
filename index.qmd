...
:::{.card .mb-3}
:::{.card-body}
[Wednesday: Discrete trait analysis II in R](wednesday.qmd){.card-title .stretched-link}
...
:::{.card .mb-3}
:::{.card-body}
[Thursday: Phylodynamics I in R and BEAST2](thursday.qmd){.card-title .stretched-link}
...
:::{.card .mb-3}
:::{.card-body}
[Friday: Phylodynamics II in BEAST2](friday.qmd){.card-title .stretched-link}
