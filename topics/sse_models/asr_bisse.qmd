...
# Exercises:
## 1. 
Simulate a collection of BiSSE trees (n=30) and use asr_marginal
...
## 2. 
In your simulations, do you notice particular situations 
where reconstructions tend to be inaccurate (when does BiSSE
get "tricked")? Are there particular configurations of tip data
that present challenges for the BiSSE model?

## 3. 
Set diversification rates in both states equal to each other when simulating
...
## 4. 
Use one of the example datasets of your choice, and carry out ancestral state reconstructions
using BiSSE, comparing to results from either ace or simmap.  
