## Fitting Markov models with stochastic character mapping
...
This code is complementary to the other one in
       ...
       to fit models using functions from phytools.
...
I also like to plot profile log-
...
#	2.
Running mcmcMk gives you distributions over the parameters. This is nice for
visualizing/quantifying uncertainty in the
estimates. Does fitMk produce something
analagous?

#	3.
What was assumed about the root states in
...
## 1.
Why do you think the mcmcMk routine does not
...
## 2.
Comment on any interesting things you see in profile
...
## 3.
In the previous runs, how did we estimate Pi, the
