...
but I guarantee that it was taught to you if you took calculus.
...
There are some challenges to obtaining a Monte Carlo estimate here. I probably can't use runif anymore
because it requires a maximum value that is finite, for one thing.
